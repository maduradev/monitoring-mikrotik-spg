	...
	<div class="panel-body">
		<form role="form" class="form-horizontal" id="form_vendor" method="post">
            <div class="form-group row" id="form-ip-mikrotik">
            	...
            	<div class="col-md-7">
                	<input type="text" class="form-control" name="ip_mikrotik" id="ip_mikrotik"/>
                </div>
            	<div class="col-md-1"></div>
            </div>
            <div class="form-group row">
            	...
            	<div class="col-md-7">
                	<input type="text" class="form-control" name="nama_mikrotik" id="nama_mikrotik"/>
                </div>
            	<div class="col-md-1"></div>
            </div>
            <div class="row">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#save').click(function(){
			$.ajax({
	            type: 'POST',
	            url: '<?php echo base_url()?>mikrotik/create',
